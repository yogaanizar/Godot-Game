...
func _draw():
	...
	lineDDA_Dash(50, 50, 300, 50, Color('05f5b9'))
	lineDDA_Dash_Point(50, 80, 300, 80, Color('05f5b9'))
	lineDDA_Point_Point(50, 110, 300, 110, Color('05f5b9'))
...
func Linear(m,c,centerx,centery,color):
	var x = ((0-c)/m)*30
	var y = (m*(0) + c)*30
	lineDDA_Dash_Point(centerx + x,centery,centerx, centery-y,color)
	pass
...
func Kartesian(centerx,centery,length,color):
	...
	lineDDA_Dash_Point(A, centery, B , centery, color)
	lineDDA_Point_Point(centerx, C, centerx , D, color)
