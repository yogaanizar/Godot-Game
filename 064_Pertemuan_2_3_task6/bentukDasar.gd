...
func square(sisi, point, color):
	lineDDA(point,point,point + sisi, point,color)
	lineDDA(point,point,point, point + sisi,color)
	lineDDA(point + sisi,point,point + sisi, point + sisi,color)
	lineDDA(point,point+sisi,point+sisi, point + sisi,color)
	pass
